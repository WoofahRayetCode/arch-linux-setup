...
sudo pacman -Sy
yay -S chatall-bin mullvad-vpn standardnotes-bin obs-backgroundremoval caprine google-chrome gcdemu xone-dkms minecraft-launcher ventoy-bin protonup-qt youtube-music-bin visual-studio-code-bin timeshift noisetorch-git
