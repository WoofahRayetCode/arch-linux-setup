...
sudo pacman -Sy
yay -S linux-xanmod-edge-linux-bin-x64v3 chatall-bin mullvad-vpn standardnotes-bin openrgb-bin liquidctl-git coolercontrol stream-overlay obs-backgroundremoval caprine google-chrome gcdemu xpadneo-dkms minecraft-launcher ventoy-bin protonup-qt youtube-music-bin visual-studio-code-bin timeshift noisetorch-git
