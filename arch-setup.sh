...
sudo pacman -Sy
sudo pacman -S nvidia lib32-nvidia-utils nvidia-utils nvidia-settings usbmuxd openh264 movit kdenlive kalarm partitionmanager mame-tools lutris qbittorrent lib32-mangohud mangohud goverlay wine-staging vulkan-icd-loader lib32-vulkan-icd-loader lib32-vulkan-mesa-layers vulkan-mesa-layers winetricks bleachbit gamemode steam discord telegram-desktop krita libreoffice-fresh obs-studio android-tools
