...
sudo pacman -Sy
sudo pacman -S usbmuxd openh264 movit kdenlive kalarm partitionmanager mame-tools lutris qbittorrent lib32-mangohud mangohud goverlay wine-staging winetricks bleachbit steam discord telegram-desktop krita libreoffice-fresh obs-studio android-tools
