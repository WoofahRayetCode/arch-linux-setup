...
sudo pacman -S pikaur powerpill wine-staging winetricks lutris timeshift bleachbit bitwarden partitionmanager steam telegram-desktop caprine krita libreoffice-fresh kdenlive qbittorrent android-tools
