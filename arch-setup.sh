...
sudo pacman -S wine-staging winetricks lutris bleachbit bitwarden partitionmanager steam telegram-desktop caprine krita libreoffice-fresh kdenlive qbittorrent android-tools
