...
sudo pacman -Sy
yay -S tlpui-git mullvad-vpn standardnotes-bin google-chrome vesktop freedownloadmanager gcdemu minecraft-launcher ventoy-bin protonup-qt youtube-music-bin visual-studio-code-bin timeshift
