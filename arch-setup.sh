...
sudo pacman -S nvidia wine-staging winetricks lutris timeshift ark bleachbit partitionmanager discord telegram-desktop krita libreoffice-fresh kdenlive bluemail qbittorrent
