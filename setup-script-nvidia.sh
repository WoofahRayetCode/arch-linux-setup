...
yay -S standardnotes-desktop birdtray-git duckstation-git citra-git minecraft-launcher protontricks winetricks widevine mellowplayer teamviewer foxitreader bitwarden-bin github-desktop-bin atom-editor-bin
