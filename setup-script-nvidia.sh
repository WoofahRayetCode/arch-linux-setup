...
sudo pacman -S nvidia lib32-nvidia-utils nvidia-utils nvidia-settings base-devel yay nano gamemode lib32-gamemode wine-staging thunderbird qbittorrent krita obs-studio bleachbit libreoffice-fresh git steam lutris discord telegram-desktop unrar p7zip
