...
sudo pacman -Sy
yay -Sy zenergy-dkms-git nvidia-prime-select onedrive-abraunegg-git peazip gnome-keyring msty-bin proton-ge-custom-bin umu-launcher sideloader-bin bluemail idevicerestore gcdemu xpadneo-dkms ventoy-bin youtube-music-bin
