...
sudo pacman -Sy base-devel linux-headers cachyos-gaming-meta partitionmanager linux-cachyos-nvidia nvidia-settings nvidia-utils lib32-nvidia-utils switcheroo-control qt6-wayland glances gamescope envycontrol ntfs-3g jre-openjdk flatpak bash-language-server usbmuxd mame-tools lib32-mangohud mangohud goverlay vulkan-icd-loader lib32-vulkan-icd-loader lib32-vulkan-mesa-layers vulkan-mesa-layers winetricks bleachbit gamemode lib32-gamemode steam android-tools
