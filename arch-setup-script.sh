...
#AUR Programs I use
yay -S duckstation-git pcsx2-git rpcs3-git ppsspp-git fceux-git snes9x-git libmgba-git melonds-git yuzu-git xemu-git goverlay protontricks davinci-resolve microsoft-edge-dev-bin signal-desktop-beta-bin etcher-bin bitwarden-bin standardnotes-bin
