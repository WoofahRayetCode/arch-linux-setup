...
#AUR Programs I use
yay -S duckstation-git pcsx2-git rpcs3-git ppsspp-git libmgba-git melonds-git goverlay protontricks davinci-resolve microsoft-edge-dev-bin signal-desktop-beta-bin etcher-bin standardnotes-bin vscodium-bin vscodium-bin-marketplace vscodium-bin-features
