...
#Main programs I use
sudo pacman -S base-devel git yay plasma-systemmonitor qbittorrent electron qt gamemode lib32-gamemode steam wine-staging winetricks lutris discord signal-desktop telegram-desktop krita libreoffice-fresh vlc bleachbit guvcview

#AUR Programs I use
yay -S duckstation-git pcsx2-git rpcs3-git ppsspp-git mgba-qt-git melonds-git citra-qt-git goverlay protontricks minecraft-launcher steamcmd microsoft-edge-dev-bin obs-studio-git davinci-resolve etcher-bin bitwarden-bin unityhub dotnet-core-bin visual-studio-code-bin github-desktop-bin standardnotes-bin
