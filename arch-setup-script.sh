...
#AUR Programs I use
yay -S duckstation-git pcsx2-git ppsspp-git libmgba-git melonds-git goverlay protontricks davinci-resolve microsoft-edge-dev-bin signal-desktop-beta-bin etcher-bin bitwarden-bin standardnotes-bin
