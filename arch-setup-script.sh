...
#AUR Programs I use
yay -S duckstation-git pcsx2-git rpcs3-git ppsspp-git mgba-qt-git melonds-git citra-qt-git goverlay protontricks minecraft-launcher steamcmd obs-studio-git davinci-resolve etcher-bin bitwarden-bin unityhub dotnet-core-bin visual-studio-code-bin github-desktop-bin standardnotes-bin
