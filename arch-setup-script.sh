...
#Main programs I use
sudo pacman -S nvidia nvidia-settings nvidia-utils git qt alacritty gamemode lib32-gamemode steam wine-staging winetricks lutris qbittorrent discord krita libreoffice-fresh vlc bleachbit spectacle
