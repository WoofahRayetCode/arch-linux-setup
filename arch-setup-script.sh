...
#AUR Programs I use
yay -S duckstation-git pcsx2-git rpcs3-git ppsspp-git mgba-qt-git melonds-git citra-qt-git dolphin-emu-git yuzu-git libmgba-git ventoy goverlay protontricks davinci-resolve obs-studio-git signal-desktop-beta-bin etcher-bin standardnotes-bin vscodium-bin vscodium-bin-marketplace vscodium-bin-features
