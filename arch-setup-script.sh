...
#AUR Programs I use
yay -S protontricks-git winetricks-git retroarch-git retroarch-assets-git duckstation-git pcsx2-git rpcs3-git ppsspp-git vbam-git desmume-git citra-qt-git obs-studio-git unityhub minecraft-launcher steamcmd dxvk mangohud-common lib32-mangohud mangohud freedownloadmanager foxitreader netstandard-targeting-pack-bin dotnet-targeting-pack-bin dotnet-sdk-bin visual-studio-code-bin github-desktop-bin etcher-bin minetime-bin standardnotes-bin davinci-resolve
