...
#Main programs I use
sudo pacman -S nvidia powerdevil qt gamemode lib32-gamemode steam wine-staging winetricks lutris qbittorrent discord krita libreoffice-fresh vlc kdenlive bleachbit spectacle
